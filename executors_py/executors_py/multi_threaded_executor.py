...
# Second node with callbacks 4 and 5
class Node2(Node):
    def __init__(self):
        super().__init__("node2")
        self.cb_group = ReentrantCallbackGroup()
        self.timer1_ = self.create_timer(1.0, self.callback_timer4, callback_group=self.cb_group)
        self.timer2_ = self.create_timer(1.0, self.callback_timer5, callback_group=self.cb_group)
